...
public partial class MiniGestionComercialContext : DbContext
{
    public MiniGestionComercialContext()
    {
    }

    public MiniGestionComercialContext(DbContextOptions<MiniGestionComercialContext> options)
        : base(options)
    {
    }
